...
> **검증일:** 2026-07-17 · Node v26.4.0 · Next.js 16.2.10 · Chrome on macOS · 기준 commit `51f672e`
...
| Unit tests (root) | PASS | `npm test` · 199/199 |
...
| BROWSER-008 | PASS · 자동화 | `e2e/fleet.spec.ts` — 함대 사전 등록 → 변형별 측정 프리필(mock segments 응답) → 웨이브 판정(승급·컷·승격 후보·다중 비교 병기) → 수렴 중단 → 새로고침 후 이력 복구 (FAC-12·FAC-14) |
